...
import com.lerss.happychosenfacade.TheChosenFacadeApplication
import com.lerss.happychosenfacade.sample.service.UserCriteria
...
@ContextConfiguration(loader = SpringApplicationContextLoader, classes = [TheChosenFacadeApplication])
    ...
    void "Mock 了一个 Service 层服务, 演示了 Facade 层的服务实现里是如何调用一个远程服务的. "() {
        ...
        mockServer.when(
                HttpRequest.request()
                        ...
                        .withPath("/service/json/com.lerss.thechosenfacade.sample.service/User/findUsersByCriteria")//path matches
